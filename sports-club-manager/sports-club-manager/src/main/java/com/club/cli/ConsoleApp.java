...
import com.club.service.ExportService;
...
public class ConsoleApp {
    ...
    public ConsoleApp(MemberRepository m, CoachRepository c, SportRepository s, ScheduleRepository sch,
        ...
        this.memberRepo = m; this.coachRepo = c; this.sportRepo = s; this.scheduleRepo = sch;
        this.competitionRepo = comp; this.resultRepo = res; this.achievementRepo = ach;
        this.feeRepo = fee; this.attendanceRepo = att; this.equipmentRepo = eq;
    ...
    private void membersMenu(){
        ...
        switch (ch){
            case "1": {
                ...
                Member m = new Member(null, name, phone); memberRepo.add(m);
                System.out.println("Đã thêm: " + m.getId());
                break;
            }
            case "2": {
                System.out.print("ID: "); String id = sc.nextLine();
                Member m = memberRepo.get(id); if (m==null){ System.out.println("Không tìm thấy"); return; }
                System.out.print("Tên mới: "); m.setName(sc.nextLine());
                System.out.print("SĐT mới: "); m.setPhone(sc.nextLine());
                System.out.println("Đã cập nhật.");
                break;
            }
            case "3": {
                System.out.print("ID: "); String id = sc.nextLine();
                memberRepo.remove(id); System.out.println("Đã xóa.");
                break;
            }
            case "4": {
                System.out.print("Từ khóa (tên/mã/sđt): "); String q = sc.nextLine().toLowerCase();
    ...
    private void coachesMenu(){
        ...
        switch (ch){
            case "1": {
                System.out.print("Tên: "); String name = sc.nextLine();
                System.out.print("SĐT: "); String phone = sc.nextLine();
                Coach c = new Coach(null, name, phone); coachRepo.add(c);
                System.out.println("Đã thêm: " + c.getId());
                break;
            }
            case "2": {
                System.out.print("ID: "); String id = sc.nextLine();
                Coach c = coachRepo.get(id); if (c==null){ System.out.println("Không tìm thấy"); return; }
                System.out.print("Tên mới: "); c.setName(sc.nextLine());
                System.out.print("SĐT mới: "); c.setPhone(sc.nextLine());
                System.out.println("Đã cập nhật.");
                break;
            }
            case "3": {
                System.out.print("ID: "); String id = sc.nextLine();
                coachRepo.remove(id); System.out.println("Đã xóa.");
                break;
            }
            case "4": {
                System.out.print("Coach ID: "); String cid = sc.nextLine();
                Coach c = coachRepo.get(cid); if (c==null){ System.out.println("Không tìm thấy"); return; }
                System.out.print("Sport ID: "); String sid = sc.nextLine();
                c.addSport(sid); System.out.println("Đã phân công.");
                break;
            }
            case "5":
    ...
    private void sportsMenu(){
        ...
        switch (ch){
            case "1": {
                ...
                System.out.print("Coach ID (có thể trống): "); String coachId = sc.nextLine().isBlank()? null : sc.nextLine();
                Sport s;
                switch (t){
                    case "1":
                ...
                sportRepo.add(s); System.out.println("Đã thêm: "+s.getId());
                break;
            }
            case "2": {
                System.out.print("Sport ID: "); String id = sc.nextLine();
                Sport s = sportRepo.get(id); if (s==null){ System.out.println("Không tìm thấy"); return; }
                System.out.print("Coach ID mới (trống = bỏ qua): "); String cid = sc.nextLine();
                if (!cid.isBlank()) s.setCoachId(cid);
                System.out.println("Lịch mặc định: "+s.getTrainingSchedule());
                break;
            }
            case "3": {
                System.out.print("Sport ID: "); sportRepo.remove(sc.nextLine()); System.out.println("Đã xóa.");
                break;
            }
            case "4": {
    ...
    private void scheduleMenu(){
        ...
        switch (ch){
            case "1": {
                System.out.print("Sport ID: "); String sid = sc.nextLine();
                System.out.print("Coach ID: "); String cid = sc.nextLine();
                System.out.print("Member IDs (phân tách ;): "); String mids = sc.nextLine();
                System.out.print("Ngày (yyyy-MM-dd): "); String d = sc.nextLine();
                System.out.print("Giờ (HH:mm): "); String t = sc.nextLine();
                System.out.print("Thời lượng (phút): "); int dur = Integer.parseInt(sc.nextLine());
    ...
    private void competitionMenu(){
        ...
        switch (ch){
            case "1": {
                System.out.print("Tên: "); String name = sc.nextLine();
                System.out.print("Ngày (yyyy-MM-dd): "); String d = sc.nextLine();
                System.out.print("Loại (L=League, T=Tournament): "); String tp = sc.nextLine();
                Competition c = "L".equalsIgnoreCase(tp) ? new League(null, name, LocalDate.parse(d)) :
                        new Tournament(null, name, LocalDate.parse(d));
                competitionRepo.add(c); System.out.println("Đã tạo: "+c.getId());
                break;
            }
            case "2": {
                System.out.print("Competition ID: "); String cid = sc.nextLine();
                System.out.print("Member ID: "); String mid = sc.nextLine();
                System.out.print("Điểm: "); int score = Integer.parseInt(sc.nextLine());
                System.out.print("Hạng: "); int rank = Integer.parseInt(sc.nextLine());
    ...
    private void reportMenu(){
        ...
        switch (ch){
            case "1": {
                var mp = reportService.membersPerSport();
                mp.forEach(new java.util.function.BiConsumer<String, Long>() {
                    @Override
            ...
            case "2": {
                var list = reportService.latestCompetitionRanking();
                for (var r : list){
            ...
            case "3": {
                var top = reportService.top5MembersAchievements();
                for (var e : top){
    ...
    private void membershipFeeMenu(){
        ...
        switch (ch){
            case "1": {
                System.out.print("Member ID: "); String mid = sc.nextLine();
                System.out.print("Số tiền: "); double amount = Double.parseDouble(sc.nextLine());
                System.out.print("Ngày thanh toán (yyyy-MM-dd): "); String payDate = sc.nextLine();
                System.out.print("Ngày hết hạn (yyyy-MM-dd): "); String expDate = sc.nextLine();
                System.out.print("Phương thức (CASH/CARD/TRANSFER): "); String method = sc.nextLine();
            ...
            case "4": {
                System.out.print("Fee ID: "); String fid = sc.nextLine();
                MembershipFee fee = feeRepo.get(fid);
                if (fee == null){ System.out.println("Không tìm thấy"); return; }
    ...
    private void attendanceMenu(){
        ...
        switch (ch){
            case "1": {
                System.out.print("Schedule ID: "); String sid = sc.nextLine();
                System.out.print("Member ID: "); String mid = sc.nextLine();
                System.out.print("Ngày (yyyy-MM-dd): "); String d = sc.nextLine();
                System.out.print("Giờ vào (HH:mm): "); String t = sc.nextLine();
                System.out.print("Trạng thái (PRESENT/ABSENT/LATE/EXCUSED): "); String st = sc.nextLine();
    ...
    private void equipmentMenu(){
        ...
        switch (ch){
            ...
            case "2": {
                ...
                if (eq == null){ System.out.println("Không tìm thấy"); return; }
    ...
    private void exportMenu(){
        ...
        try {
            switch (ch){
                ...
                case "2": {
                    System.out.print("Competition ID: "); String cid = sc.nextLine();
                    System.out.print("Đường dẫn file: "); String path = sc.nextLine();
